...
function App() {
  return (
    <>
      <Navbar />
      <main className="max-w-[90%] mx-auto overflow-hidden">
        <HeroSec />
        ...
        <section id="Electronics">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 items-center gap-5 bg-[#fefddd] p-3">
            <div>
              <CategoryCard
                tagName={"Appliances flash deals"}
                image={
                  "https://f.nooncdn.com/p/pnsku/N32628385A/45/_/1730219914/f39bf008-efeb-4785-ae74-62560d9ae181.jpg?width=240"
                }
                title={
                  "Powerful Mixer Grinder, 2 Stainless Steel Jars, Compact And Versatile For Everyday Kitchen Use 1 L 1000 W MX-AC210S White"
                }
                price={"169"}
                oldPrice={"336"}
              />
            ...
            <div>
              <CategoryCard
                ...
                image={
                  "https://f.nooncdn.com/p/v1662714333/N15659605A_1.jpg?width=240"
                }
                title={
                  "Gentle Skin Cleanser, Face And Body Wash For Men And Women, Dry To Normal And Sensitive Skin, Unscented 500ml"
                }
                price={"72"}
                oldPrice={"297"}
              />
            ...
            <div>
              <CategoryCard
                ...
                image={
                  "https://f.nooncdn.com/p/pzsku/ZB5FE2F7B51417A112184Z/45/_/1740187020/bbc6a7e4-2c3e-45ef-937d-6b2c2b268d11.jpg?width=240"
                }
                title={
                  "Ramadan Crescent Moon Tree Decor - 180CM PVC Artificial Decorative Tree for Eid al-Fitr, Islamic Home & Garden Decor (Green)"
                }
                price={"141"}
                oldPrice={"491"}
              />
            ...
            <div>
              <CategoryCard
                ...
                image={
                  "https://f.nooncdn.com/p/pnsku/N70011684V/45/_/1711412245/53b8c02e-8e17-4e96-8af5-4d5dd8b90736.jpg?width=240"
                }
                title={
                  "Matebook D14 Laptop 14 Inch FHD Display, Intel Core i7-1360P Processor/16GB RAM/1TB SSD/Intel Iris Xe Graphics/Windows 11 English/Arabic Mystic Silver"
                }
                price={"3525"}
                oldPrice={"5299"}
              />
            ...
            <div>
              <CategoryCard
                tagName={"Health flash deals"}
                image={
                  "https://f.nooncdn.com/p/pzsku/Z90F223CDAA4E7BBA22C9Z/45/_/1682502750/f7d719ed-c279-41ba-af83-c9424c0345d4.jpg?width=240"
                }
                title={
                  "30ct/300mg Multi Award Winning Patented NAD+ Boosting Supplement - More Efficient Than NMN - Nicotinamide Riboside for Cellular Energy Metabolism & Repair, Vitality, Muscle Health, Healthy Aging"
                }
                price={"162 "}
                oldPrice={"269"}
              />
          ...
          <div className="bg-white mt-3 p-4">
            ...
            <div className="grid  grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-1">
              <DealsCard
                ...
                title={
                  "Sony PlayStation 5 Slim Console (International Version) Disc Version With Controller - New Model 2023 "
                }
                price={"7105"}
                oldPrice={"2,999"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "porodo 27 Gaming Curved Monitor FHD Monitor MT9800 Solution  240Hz refresh rate / Nvidia G-Sync with RGB light - Black "
                }
                price={"692"}
                oldPrice={"1,999"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "HYPERX HyperX Cloud II Wired Gaming Headset - Black-Red "
                }
                price={"185"}
                oldPrice={"369"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "EA EA Sports FC 25 (International Version) - Sports - PlayStation 5 (PS5) "
                }
                price={"125"}
                oldPrice={"150"}
                cartIcon={true}
              ...
              <DealsCard
                image={
                  "https://f.nooncdn.com/p/pzsku/ZF8DD517BBBC440753B5EZ/45/_/1714410351/3acbfae6-0ad8-4bc5-8ab4-48b995dab4f1.jpg?format=jpg&width=240"
                }
                title={
                  "Microsoft Microsoft Office 365 Long Term Brand New Account | 1 Device access For Mac | Windows | Mobile With OneDrive "
                }
                price={"120"}
                oldPrice={"199"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "Microsoft Office 365 Lifetime Subscription Account | Up to 5 Device for MacOS, Windows, iOs & Android With OneDrive "
                }
                price={"217"}
                oldPrice={"499"}
                cartIcon={true}
          ...
          <div className="bg-white p-4">
            ...
            <div className="grid  grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-1">
              ...
              <DealsCard
                ...
                title={
                  "Revlon RVDR5222 One-Step Hair Dryer And Volumizer Black/Pink "
                }
                price={"89"}
                oldPrice={"226"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "MINIMALIST 10% Vitamin B5 Gel Face Moisturizer For Oily And Acne Prone Skin | Oil-free | Fast Absorbing Lightweight Winter Cream For Women And Men | Non sticky | Fragrance Free"
                }
                price={"699"}
                oldPrice={"899"}
                cartIcon={true}
        ...
        <section id="home appliances">
          <div className="bg-white p-4">
            ...
            <div className="grid  grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-1">
              ...
              <DealsCard
                image={
                  "https://f.nooncdn.com/p/v1678640834/N11426641A_1.jpg?format=jpg&width=240"
                }
                title={
                  "BLACK+DECKER Digital Air Fryer, Rapid Air Convection Technology, Multi-Function for Frying, Baking, Grilling & Roasting, Cool-Touch Handle, Safety Lock, 4 L 1500 W AF400-B5 Black "
                }
                price={"169"}
                oldPrice={"685"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "NIKAI Microwave Oven, Digital Touch Control, Child Safety-Lock, 10/11 Power Levels And 6 Auto Menus, Cooking End Signal, Touch Control Panel, Convenient Pull Hand Door 20 L 700 W NM02010DBX Black "
                }
                price={"179"}
                oldPrice={"349"}
                cartIcon={true}
              ...
              <DealsCard
                ...
                title={
                  "BLACK+DECKER Portable Garment Steamer, Universal Bottle Adapter, Fine Mist Spray, Ergonomic Compact Design, Effective on All Fabrics, 0.26 L 1500 W HST1500-B5 Dark Purple "
                }
                price={"99"}
                oldPrice={"329"}
                cartIcon={true}
              ...
              <DealsCard
                image={
                  "https://f.nooncdn.com/p/pnsku/N44694097A/45/_/1699348672/190a87a7-8341-47b3-8d22-76a8f2de2ecd.jpg?format=jpg&width=240"
                }
                title={
                  "NIKAI 130L Gross / 90L Net, Single Door Mini Refrigerator, Chiller And Veg. Compartment, 2 Glass Shelves And Bottle Storage Racks, Compact Small Size Beverage Fridge, Child Lock, Best For Home, Office, Bedroom 130 L 281 kW NRF130SS1 Grey "
                }
                price={"339"}
                oldPrice={"499"}
                cartIcon={true}
